...
module.exports = function forbidden (data, options) {
  ...
  if (options.view) {
    ...
    return res.view('errors/403', { data: viewData, title: 'Forbidden' }, function (err, html) {
      ...
      if (err) {
        ...
        if (err.code === 'E_VIEW_FAILED') {
          sails.log.verbose('res.forbidden() :: Could not locate view for error'
          + ' page (sending JSON instead).  Details: ',err);
        } else {
